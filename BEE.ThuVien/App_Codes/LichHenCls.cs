...
namespace it
{
    ...
    {
        public int MaLH, MaNVCN;
        public string TieuDe;
        public string DienGiai, NhanVienStr;
        public string DiaDiem, Rings;
        ...
        public int TongSoNgay, MaNC, MaHD,MaBCSP,MaLoai;
        ...
        public LichHenCls(int _MaLH)
        {
            ...
            if (dread.Read())
            {
                ...
                NhanVienStr = dread["NhanVien"] as string;
                ...
                MaNVCN = dread["MaNVCN"].ToString() == "" ? 0 : int.Parse(dread["MaNVCN"].ToString());
            }
            sqlCon.Close();
        }
        ...
        public int Insert()
        {
            ...
            sqlCmd.Parameters.AddWithValue("@MaBCSP", MaBCSP);
        ...
        public void Update()
        {
            ...
            sqlCmd.Parameters.AddWithValue("@TimeID2", TimeID2);
            sqlCmd.Parameters.AddWithValue("@NhanVien", NhanVienStr);
            sqlCmd.Parameters.AddWithValue("@MaNVCN", MaNVCN);
            sqlCon.Open();
            sqlCmd.ExecuteNonQuery();
            sqlCon.Close();
        }
        ...
        public DataTable SelectByGroup()
        {
            ...
            sqlCmd.Parameters.AddWithValue("@TuNgay", NgayBD);
            sqlCmd.Parameters.AddWithValue("@DenNgay", NgayKT);
            sqlCmd.Parameters.AddWithValue("@GroupID", NhanVien.NKD.MaNKD);
            sqlCmd.Parameters.AddWithValue("@MaCD", ChuDe.TenCD);
            sqlCmd.Parameters.AddWithValue("@MaTD", ThoiDiem.TenTD);
            sqlCmd.Parameters.AddWithValue("@MaNV", NhanVien.MaNV);
            SqlDataAdapter sqlDA = new SqlDataAdapter(sqlCmd);
        ...
        public DataTable SelectByDepartment()
        {
            ...
            sqlCmd.Parameters.AddWithValue("@TuNgay", NgayBD);
            sqlCmd.Parameters.AddWithValue("@DenNgay", NgayKT);
            sqlCmd.Parameters.AddWithValue("@DepID", NhanVien.PhongBan.MaPB);
            sqlCmd.Parameters.AddWithValue("@MaCD", ChuDe.TenCD);
            sqlCmd.Parameters.AddWithValue("@MaTD", ThoiDiem.TenTD);
            sqlCmd.Parameters.AddWithValue("@MaNV", NhanVien.MaNV);
            SqlDataAdapter sqlDA = new SqlDataAdapter(sqlCmd);
