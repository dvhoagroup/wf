...
namespace it
{
    public class KyBaoCaoCls
    {
        ...
        private string[] strSource2 = new string[] { 
                "Hôm nay", "Tuân này", "Đầu tuần đến hiện tại", "Tháng này", "Đầu tháng đến hiện tại",
                "Quý này", "Đầu quý đến hiện tại", "Tháng 1", 
                "Tháng 2", "Tháng 3", "Tháng 4", "Tháng 5", "Tháng 6", "Tháng 7", "Tháng 8", "Tháng 9",
                "Tháng 10", "Tháng 11", "Tháng 12", "Quý I", "Quý II", "Quý III", "Quý IV"
            };
        #endregion
        ...
        public void Initialize2(DevExpress.XtraEditors.Repository.RepositoryItemComboBox cmd)
        {
            foreach (string str in strSource2)
            {
                cmd.Items.Add(str);
            }
        }
        ...
        public void SetToDate()
        {
            ...
            {
                case 0: //Tu chon
                    DateFrom = new DateTime(2012, 5, 28);
                    DateTo = dateNow;
                    break;
                case 1: //Ngay nay
                    DateFrom = dateNow;
