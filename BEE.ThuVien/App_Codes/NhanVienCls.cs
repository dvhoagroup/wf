...
namespace it
{
	public class NhanVienCls
	{
		...
		{
			SqlConnection sqlCon = new SqlConnection(CommonCls.Conn);
			SqlDataAdapter sqlDA = new SqlDataAdapter("NhanVien_getAll", sqlCon);
		...
		{
			SqlConnection sqlCon = new SqlConnection(CommonCls.Conn);
			SqlCommand sqlCmd = new SqlCommand("NhanVien_delete", sqlCon);
			sqlCmd.CommandType = CommandType.StoredProcedure;
			sqlCmd.Parameters.AddWithValue("@MaNV", MaNV);
			sqlCon.Open();
			sqlCmd.ExecuteNonQuery();
        ...
        public void ChangePassword(int staffID)
        {
            ...
            sqlCmd.Parameters.AddWithValue("@ChangedPass", ChangedPass);
            sqlCon.Open();
            sqlCmd.ExecuteNonQuery();
            sqlCon.Close();
        }
        ...
        {
            SqlConnection sqlCon = new SqlConnection(CommonCls.Conn);
            SqlCommand sqlCmd = new SqlCommand("NhanVien_updateLock", sqlCon);
            sqlCmd.CommandType = CommandType.StoredProcedure;
            sqlCmd.Parameters.AddWithValue("@MaNV", MaNV);
            sqlCmd.Parameters.AddWithValue("@Lock", Lock);
            sqlCmd.Parameters.AddWithValue("@MaNVCN", staffIDModify);
