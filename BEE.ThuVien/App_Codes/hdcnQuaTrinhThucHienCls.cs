...
namespace it
{
	public class hdcnQuaTrinhThucHienCls
	{
		public int MaHDCN;
		public byte Lan;
		...
		public hdcnQuaTrinhThucHienCls()
		{
		}

        public hdcnQuaTrinhThucHienCls(int _MaHDCN, byte _Lan)
		{
			SqlConnection sqlCon = new SqlConnection(CommonCls.Conn);
			SqlCommand sqlCmd = new SqlCommand("dhcnQuaTrinhThucHien_get", sqlCon);
		...
		{
			SqlConnection sqlCon = new SqlConnection(CommonCls.Conn);
			SqlCommand sqlCmd = new SqlCommand("dhcnQuaTrinhThucHien_add", sqlCon);
			sqlCmd.CommandType = CommandType.StoredProcedure;
		...
		{
			SqlConnection sqlCon = new SqlConnection(CommonCls.Conn);
			SqlCommand sqlCmd = new SqlCommand("dhcnQuaTrinhThucHien_update", sqlCon);
			sqlCmd.CommandType = CommandType.StoredProcedure;
			sqlCmd.Parameters.AddWithValue("@MaHDCN", MaHDCN);
		...
		{
			SqlConnection sqlCon = new SqlConnection(CommonCls.Conn);
			SqlDataAdapter sqlDA = new SqlDataAdapter("dhcnQuaTrinhThucHien_getAll", sqlCon);
        ...
        {
            SqlConnection sqlCon = new SqlConnection(CommonCls.Conn);
            SqlDataAdapter sqlDA = new SqlDataAdapter("dhcnQuaTrinhThucHien_getAllByMaHDCN " + _MaHDCN, sqlCon);
            DataSet dSet = new DataSet();
            sqlCon.Open();
            sqlDA.Fill(dSet);
            sqlCon.Close();
		...
		{
			SqlConnection sqlCon = new SqlConnection(CommonCls.Conn);
			SqlCommand sqlCmd = new SqlCommand("dhcnQuaTrinhThucHien_delete", sqlCon);
			sqlCmd.CommandType = CommandType.StoredProcedure;
			sqlCmd.Parameters.AddWithValue("@MaHDCN", MaHDCN);
			sqlCmd.Parameters.AddWithValue("@Lan", Lan);
			sqlCon.Open();
