...
namespace BEE.THUCHI.PhieuThu
{
    public partial class ctlManagerCongNo : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        int GetAccessData()
        {
            it.AccessDataCls o = new it.AccessDataCls(Common.PerID, 33);
        ...
        void GiaoDich_Load()
        {
            ...
            try
            {
                ...
                {
                    case 1://Tat ca
                        gcLichTT.DataSource = db.pgcPhieuThuMGL_Select(tuNgay, denNgay, 0, 0, 0).ToList();
                        break;
                    case 2://Theo phong ban
                        gcLichTT.DataSource = db.pgcPhieuThuMGL_Select(tuNgay, denNgay,  (byte)BEE.ThuVien.Common.DepartmentID, 0, 0);
                        break;
                    case 3://Theo nhom
                        gcLichTT.DataSource = db.pgcPhieuThuMGL_Select(tuNgay, denNgay, 0, Common.GroupID, 0);
                        break;
                    case 4://Theo nhan vien
                        gcLichTT.DataSource = db.pgcPhieuThuMGL_Select(tuNgay, denNgay, 0, 0, Common.StaffID);
                        break;
                    default:
        ...
        {
            SetDate(0);
            lkLoaiThu.DataSource = db.pgcLoaiPhieuThuChis;
