...
{
    public partial class rptTienCoc : DevExpress.XtraReports.UI.XtraReport
    {
        public rptTienCoc(int ID)
        {
            InitializeComponent();
            ...
            try
            {
                using (var db = new MasterDataContext())
                {
                    ...
                    cellConPhaiNop.Text = string.Format("{0:#,0.#}", obj.TuongUngTT - obj.ThucNop);
