...
namespace BEE.SoQuy.PhieuThanhToan
{
    public partial class ctlManager : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void itemIn_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            switch ((int)grvPhieuTT.GetFocusedRowCellValue("LoaiPTT"))
            {
                case 1:
                    var rpt1 = new rptNormalDat((int)grvPhieuTT.GetFocusedRowCellValue("MaPTT"));
                    rpt1.ShowPreviewDialog();
                    break;
                case 2:
                    var rpt2 = new rptThueDat((int)grvPhieuTT.GetFocusedRowCellValue("MaPTT"));
                    rpt2.ShowPreviewDialog();
                    break;
                case 3:
                    var rpt3 = new rptNormalXD((int)grvPhieuTT.GetFocusedRowCellValue("MaPTT"));
                    rpt3.ShowPreviewDialog();
                    break;
                case 4:
                    var rpt4 = new rptNormalXD_VATDat((int)grvPhieuTT.GetFocusedRowCellValue("MaPTT"));
