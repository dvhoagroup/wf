...
namespace DemoChart
{
    public partial class frmSideBySideBar3D : Form
    {
        ChartControl barChart3D = new ChartControl();
        public frmSideBySideBar3D()
        {
            InitializeComponent();
        }
        ...
        void FullStackedBar()
        {
            ...
            o = new Random();
            series1.Points.Add(new SeriesPoint("Đợt 5", 2 * o.Next(50, 180)));
            o2 = new Random();
            series2.Points.Add(new SeriesPoint("Đợt 5", 2 * o2.Next(20, 150)));
            o3 = new Random();
            series3.Points.Add(new SeriesPoint("Đợt 5", 2 * o2.Next(20, 150)));
            o4 = new Random();
            series4.Points.Add(new SeriesPoint("Đợt 5", 2 * o2.Next(20, 150)));

            o = new Random();
            series1.Points.Add(new SeriesPoint("Đợt 6-7", 3 * o.Next(50, 50)));
            o2 = new Random();
            series2.Points.Add(new SeriesPoint("Đợt 6-7", 3 * o2.Next(20, 50)));
            o3 = new Random();
            series3.Points.Add(new SeriesPoint("Đợt 6-7", 3 * o2.Next(20, 50)));
            o4 = new Random();
            series4.Points.Add(new SeriesPoint("Đợt 6-7", 3 * o2.Next(20, 50)));
    ...
    "41515552;0;0;0;0;1";
            ...
            //barChart3D.Legend.Font = new Font("Calibri", 10);
            //two row
