...
{
    public partial class rptDoanhSoBanHangTheoSan : DevExpress.XtraReports.UI.XtraReport
    {
        int STTGroup = 0;
        int STT = 0;

        public rptDoanhSoBanHangTheoSan(DateTime? start, DateTime? end)
        {
            InitializeComponent();
            ...
            using (var db = new MasterDataContext())
            {
                ...
                this.DataSource = db.rptDoanhSoBanHangTheoSan(start, end);
            }
        }
