...
{
    public partial class ctlKhachHangLevel : DevExpress.XtraEditors.XtraUserControl
    {
        public ctlKhachHangLevel()
        {
            InitializeComponent();
            ...
            try
            {
                ...
                using (var db = new MasterDataContext())
                {
                    var ltHTK = (from kh in db.KhachHangs
                                 join lv in db.cdLevels on kh.LevelID equals lv.ID
                                 group lv by new { lv.ID, lv.Name } into gr
                                   select new 
                                   {
                                       Name = gr.Key.Name,
                                       SoLuong = gr.Count()
                    ...
                    var strTitle = "Chart Of Customers By Level";
        ...
        private void ctlKhachHangLevel_Load(object sender, EventArgs e)
        {
            BaoCao_Nap();
        }
