...
namespace BEE.HoatDong.MGL.Ban
{
    public partial class ctlManager : DevExpress.XtraEditors.XtraUserControl
    {
                ...
                switch (GetAccessData())
                {
                    case 1://Tat ca
                        ...
                        if (obj.DienThoai == false)
                        {
                            ...
                            TotalRecord = data.FirstOrDefault().TotalRows ?? 0;
                            //try
                            //{
        ...
        private void itemChaoKhachHang_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {

        }

        private void itemSendEmail_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (grvMuaThue.FocusedRowHandle < 0)
            {
                DialogBox.Infomation("Bạn vui lòng chọn khách hàng để gửi Email!");
