...
namespace BEE.HoatDong.MGL.LichSu
{
        ...
        void GiaoDich_Load()
        {
            ...
            itemDaKyHD.DataSource = (from gd in db.GiaoDichjs
                                     ...
                                     select new
                                     {
                                         ...
                                         DaChi = db.getDaChiHoaHong(gd.ID),
                                         // ConLaiMG = gd.SoTien - db.getDaThuMG(gd.ID),
                                         PhaiChi = gd.mglgdHHNhanViens.Sum(t => t.SoTien) - db.getDaChiHoaHong(gd.ID),
                                         gd.NVKD,
                                         gd.NVVP,
                                         HoTenNV = nv.HoTen,
                                         gd.Nguon,
                                         gd.GhiChu,
                                         TienDV = db.getTienDV(gd.ID),
