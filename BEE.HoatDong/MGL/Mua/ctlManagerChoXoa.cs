...
namespace BEE.HoatDong.MGL.Mua
{
    public partial class ctlManagerChoXoa : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        int GetAccessData()
        {
            it.AccessDataCls o = new it.AccessDataCls(Common.PerID, 22);
                ...
                switch (GetAccessData())
                {
                    case 1://Tat ca
                        ...
                        if (obj.DienThoai == false)
                            gcMuaThue.DataSource = db.mglmtMuaThue_getByDateChoXoa(tuNgay, denNgay, MaTT, true, -1, -1, -1, -1, MaNV, true)
                                .Select(mt => new
                                {
                                    mt.STT,
                                    mt.MaTT,
                            ...
                            gcMuaThue.DataSource = db.mglmtMuaThue_getByDateChoXoa(tuNgay, denNgay, MaTT, true, -1, -1, -1, -1, MaNV, true);//.Where(p => p.IsMua.GetValueOrDefault() == true);
                        #endregion
                        break;
                    case 2://Theo phong ban 
                        #region Theo phong ban
                        if (obj.DienThoai == false)
                            gcMuaThue.DataSource = db.mglmtMuaThue_getByDateChoXoa(tuNgay, denNgay, MaTT, true, -1, -1, -1, Common.DepartmentID, MaNV, false)
                                .Select(mt => new
                                {
                                    mt.STT,
                                    mt.MaTT,
                            ...
                            gcMuaThue.DataSource = db.mglmtMuaThue_getByDateChoXoa(tuNgay, denNgay, MaTT, true, -1, -1, -1, Common.DepartmentID, MaNV, false);//.Where(p => p.IsMua.GetValueOrDefault() == true);
                        #endregion
                        break;
                    case 3://Theo nhom
                        #region Theo nhom
                        if (obj.DienThoai == false)
                            gcMuaThue.DataSource = db.mglmtMuaThue_getByDateChoXoa(tuNgay, denNgay, MaTT, true, -1, -1, Common.GroupID, -1, MaNV, false)
                                .Select(mt => new
                                {
                                    mt.STT,
                                    mt.MaTT,
                            ...
                            gcMuaThue.DataSource = db.mglmtMuaThue_getByDateChoXoa(tuNgay, denNgay, MaTT, true, -1, -1, Common.GroupID, -1, MaNV, false);//.Where(p => p.IsMua.GetValueOrDefault() == true);
                        #endregion
                        break;
                    case 4://Theo nhan vien
                        #region Theo nhan vien
                        if (obj.DienThoai == false)
                            gcMuaThue.DataSource = db.mglmtMuaThue_getByDateChoXoa(tuNgay, denNgay, MaTT, true, MaNV, MaNV, -1, -1, MaNV, false)
                                .Select(mt => new
                                {
                                    mt.STT,
                                    mt.MaTT,
