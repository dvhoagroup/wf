...
{
    public partial class ctlManagerChaoHang : DevExpress.XtraEditors.XtraUserControl
    {
        MasterDataContext db = new MasterDataContext();

        public ctlManagerChaoHang()
        {
            InitializeComponent();
        }
        ...
        private void ctlManagerChaoHang_Load(object sender, EventArgs e)
        {
        ...
        private void itemSP_GiaoDich_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            int rowCount = db.mglgdGiaoDiches.Where(p => p.MaMT == maMT).Count();
            if (rowCount > 0)
            {
