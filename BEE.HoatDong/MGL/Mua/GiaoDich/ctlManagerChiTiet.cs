...
{
    public partial class ctlManagerChiTiet : DevExpress.XtraEditors.XtraUserControl
    {
        MasterDataContext db = new MasterDataContext();

        public ctlManagerChiTiet()
        {
            InitializeComponent();
        ...
        void GiaoDich_Load()
        {
            ...
            itemDaKyHD.DataSource = (from gd in db.GiaoDichjs
                                     ...
                                     join dv in db.mglgdHHNhanViens on gd.ID equals dv.MaGD
                                     join nv in db.NhanViens on dv.MaNV equals nv.MaNV
                                     where SqlMethods.DateDiffDay(tuNgay, gd.NgayGD) >= 0 & SqlMethods.DateDiffDay(gd.NgayGD, denNgay) >= 0 & gd.Duyet == true
                                     select new
                                     {
                                         gd.ID,
                                         gd.MaKH,
                                         ...
                                         gd.HHNhanVien,
                                         gd.TienPhucLoi,
                                         DaThuMG = 0,// db.getDaThuMG(gd.ID),
                                         DaChi = 0,//db.getDaChiHoaHong(gd.ID),
                                         ConLaiMG = gd.SoTien - 0 /*db.getDaThuMG(gd.ID)*/,
                                         PhaiChi = 0,// gd.mglgdHHNhanViens.Sum(t => t.SoTien) - db.getDaChiHoaHong(gd.ID),
                                         gd.NVKD,
                                         gd.NVVP,
                                         nv.HoTen,
                                         gd.Nguon,
