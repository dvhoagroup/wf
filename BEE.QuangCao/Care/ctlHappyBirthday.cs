...
{
    public partial class ctlHappyBirthday : UserControl
    {
        MasterDataContext db;
        public ctlHappyBirthday()
        {
            InitializeComponent();
        ...
        void LoadData()
        {
            ...
            try
            {
                ...
                {
                    case 1://Tat ca
                        gcHappyBirthday.DataSource = db.KhachHang_getBirthday(tuNgay, denNgay, maNKH, ageFrom, ageTo, 0, 0, 0);
                        break;
                    case 2://Theo phong ban
                        gcHappyBirthday.DataSource = db.KhachHang_getBirthday(tuNgay, denNgay, maNKH, ageFrom, ageTo, BEE.ThuVien.Common.DepartmentID, 0, 0);
                        break;
                    case 3://Theo nhom
                        gcHappyBirthday.DataSource = db.KhachHang_getBirthday(tuNgay, denNgay, maNKH, ageFrom, ageTo, 0, BEE.ThuVien.Common.GroupID, 0);
                        break;
                    case 4://Theo nhan vien
                        gcHappyBirthday.DataSource = db.KhachHang_getBirthday(tuNgay, denNgay, maNKH, ageFrom, ageTo, 0, 0, BEE.ThuVien.Common.StaffID);
                        break;
                    default://Tat ca
                        gcHappyBirthday.DataSource = null;
                        break;
                }
            }
            catch { }
        ...
        private void itemGift_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                int index = gvHappyBirthday.FocusedRowHandle;
                LoadData();
                if (index == 0)
                    LoadDetail();
            }
        ...
        private void itemMail_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (fConfirm.DialogResult == DialogResult.OK)
            {
                if (fConfirm.IsNow)
                {
                    ...
                    objGroup.ReceName = "Cty Kiến Á gửi mail chúc mừng sinh nhật";
                    ...
                    {
                        if (int.Parse(gvHappyBirthday.GetRowCellValue(i, "IsEmail").ToString()) == 0)
                        {
                    ...
                    objSend.Title = "Cty Kiến Á gửi mail chúc mừng sinh nhật";
                    objSend.Active = true;
                ...
                else//Tao danh sach nguoi nhan
                {
                    ...
                    foreach (int r in Rows)
                    {
                        if (int.Parse(gvHappyBirthday.GetRowCellValue(r, "IsEmail").ToString()) == 0)
                        {
                            o = new bdsSanPham();
        ...
        private void itemSMS_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (fConfirm.DialogResult == DialogResult.OK)
            {
                if (fConfirm.IsNow)
                {
                    ...
                    objGroup.GroupName = "Cty Kiến Á gửi SMS chúc mừng sinh nhật";
                    objGroup.Description = "Hệ thống tự động tạo danh sách người nhận theo yêu cầu của " + BEE.ThuVien.Common.StaffName;
                    db.SMSGroupReceives.InsertOnSubmit(objGroup);
                    ...
                    foreach (int i in Rows)
                    {
                        if (int.Parse(gvHappyBirthday.GetRowCellValue(i, "IsSMS").ToString()) == 0)
                        {
                            objCare = new CareCustomer();
                            objCare.CustomerID = Convert.ToInt32(gvHappyBirthday.GetRowCellValue(i, "MaKH"));
                            objCare.CateID = 3;
                ...
                else//Tao danh sach nguoi nhan
                {
                    ...
                    foreach (int r in Rows)
                    {
                        if (int.Parse(gvHappyBirthday.GetRowCellValue(r, "IsSMS").ToString()) == 0)
                        {
                            o = new bdsSanPham();
                            o.MaKH = Convert.ToInt32(gvHappyBirthday.GetRowCellValue(r, "MaKH"));
                            o.ThanhTien = 0;
        ...
        private void itemExport_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            sfd.Title = "Chọn thư mục lưu file";
            sfd.FileName = "Customer" + DateTime.Now.ToString("dd-MM-yyyy") + ".xlsx";

            if (sfd.ShowDialog() == DialogResult.OK)
                gvHappyBirthday.ExportToXlsx(sfd.FileName);
        }
    }
}
